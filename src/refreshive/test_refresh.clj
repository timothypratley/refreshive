...
(defn start []
  (let [dir (str (.getCanonicalPath (clojure.java.io/file ".")) "/")
        dirs ["src" "test"]
        full-dirs (mapv str (repeat dir) dirs)]
    (println "MONTORING" full-dirs)
    (monitor-project dirs {})))